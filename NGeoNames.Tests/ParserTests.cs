...
namespace NGeoNames.Tests
{
    ...
    public class ParserTests
    {
        ...
        {
            Assert.Throws<ParserException>(() => GeoFileReader.ReadAdmin1Codes(@"testdata\invalid_admin1CodesASCII.txt").ToArray());
        }
        ...
        {
            Assert.Throws<InvalidDataException>(() => GeoFileReader.ReadCountryInfo(@"testdata\countryInfo_not_gzip_compat.txt.gz").ToArray());
        }
